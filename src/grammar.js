...
var grammar = {
    ...
    {"name": "line", "symbols": [(lexer.has("ID") ? {type: "ID"} : ID), "line$ebnf$1", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,params,,ty,     ]) => Decl(id.value,params,ty)},
    {"name": "line$ebnf$2", "symbols": []},
    {"name": "line$ebnf$2", "symbols": ["line$ebnf$2", "param"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "line", "symbols": [(lexer.has("ID") ? {type: "ID"} : ID), "line$ebnf$2", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("DEF") ? {type: "DEF"} : DEF), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,params,,ty,,def,]) => Def(id.value,params,ty,def)},
    {"name": "line$ebnf$3", "symbols": [(lexer.has("ID") ? {type: "ID"} : ID)], "postprocess": id},
    {"name": "line$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "line", "symbols": ["line$ebnf$3", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("LONGARROW") ? {type: "LONGARROW"} : LONGARROW), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,c,lhs,,rhs,])      => Rew(lhs,rhs,id?id.value:'unnamed'+c.line)},
    ...
    {"name": "line", "symbols": ["line$ebnf$4", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("LONGFATARROW") ? {type: "LONGFATARROW"} : LONGFATARROW), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,c,lhs,,rhs,])      => Rew(lhs,rhs,id?id.value:'unnamed'+c.line,false)},
    {"name": "line", "symbols": [(lexer.has("CMD_REQ") ? {type: "CMD_REQ"} : CMD_REQ), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,id])         => CmdReq(id)},
    {"name": "line", "symbols": [(lexer.has("CMD_REQ") ? {type: "CMD_REQ"} : CMD_REQ), (lexer.has("QID") ? {type: "QID"} : QID), (lexer.has("LEFTSQU") ? {type: "LEFTSQU"} : LEFTSQU), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("RIGHTSQU") ? {type: "RIGHTSQU"} : RIGHTSQU), (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,id,,alias,]) => CmdReq(id,alias)},
    {"name": "line", "symbols": [(lexer.has("CMD_EVAL") ? {type: "CMD_EVAL"} : CMD_EVAL), "ctxt", "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,c,t])          => CmdEval(c,t)},
    {"name": "line", "symbols": [(lexer.has("CMD_INFER") ? {type: "CMD_INFER"} : CMD_INFER), "ctxt", "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,c,t])          => CmdInfer(c,t)},
    {"name": "line", "symbols": [(lexer.has("CMD_CHECK") ? {type: "CMD_CHECK"} : CMD_CHECK), "ctxt", "aterm", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,c,t,,ty])      => CmdCheckType(c,t,ty)},
    {"name": "line", "symbols": [(lexer.has("CMD_CHECK") ? {type: "CMD_CHECK"} : CMD_CHECK), "ctxt", "aterm", (lexer.has("CONV") ? {type: "CONV"} : CONV), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,c,t1,,t2])     => CmdCheckConv(c,t1,t2)},
    {"name": "line", "symbols": [(lexer.has("CMD_PRINT") ? {type: "CMD_PRINT"} : CMD_PRINT), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,t])          => CmdPrint(t)},
    ...
    {"name": "param", "symbols": [(lexer.has("LEFTPAR") ? {type: "LEFTPAR"} : LEFTPAR), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("RIGHTPAR") ? {type: "RIGHTPAR"} : RIGHTPAR)], "postprocess": ([,v,,ty]) => [v,ty]},
