...
var grammar = {
    ...
    {"name": "line", "symbols": [(lexer.has("CMD_THM") ? {type: "CMD_THM"} : CMD_THM), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,id,,ty       ,e]) => Thm(e.line,id.value,ty)},
    {"name": "line", "symbols": [(lexer.has("CMD_THM") ? {type: "CMD_THM"} : CMD_THM), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("DEF") ? {type: "DEF"} : DEF), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,id,,ty,,def  ,e]) => Thm(e.line,id.value,ty,def)},
    ...
    {"name": "line", "symbols": [(lexer.has("CMD_TIME") ? {type: "CMD_TIME"} : CMD_TIME), (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([              ,e]) => CmdTime(e.line)},
    ...
    {"name": "term", "symbols": [(lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("FATARROW") ? {type: "FATARROW"} : FATARROW), "term"], "postprocess": ([id,,body])       => Lam(id.value,Joker(),body)},
