...
var grammar = {
    ...
    {"name": "line", "symbols": [(lexer.has("ID") ? {type: "ID"} : ID), "line$ebnf$2", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("DEF") ? {type: "DEF"} : DEF), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,params,,ty,,def,e]) => Def(e.line,id.value,params,ty,def)},
    ...
    {"name": "line", "symbols": ["line$ebnf$3", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("LONGARROW") ? {type: "LONGARROW"} : LONGARROW), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,c,lhs,,rhs     ,e]) => Rew(e.line,lhs,rhs,id?id.value:'unnamed'+c.line)},
    ...
    {"name": "line", "symbols": ["line$ebnf$4", (lexer.has("COLON") ? {type: "COLON"} : COLON), "term", (lexer.has("LONGFATARROW") ? {type: "LONGFATARROW"} : LONGFATARROW), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([id,c,lhs,,rhs     ,e]) => Rew(e.line,lhs,rhs,id?id.value:'unnamed'+c.line,false)},
    ...
    {"name": "line", "symbols": [(lexer.has("CMD_CHECK") ? {type: "CMD_CHECK"} : CMD_CHECK), "ctxt", "aterm", (lexer.has("CONV") ? {type: "CONV"} : CONV), "term", (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,c,t1,,t2         ,e]) => CmdCheckConv(e.line,c,t1,t2)},
